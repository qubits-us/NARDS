...
#define CMD_MOTOR          5// "CMD_MOTOR"           //Motor control command
#define CMD_POWER          11// "CMD_POWER"           //Power control command
#define CMD_BUZZER         4// "CMD_BUZZER"          //BUZZER control command
#define CMD_SERVO          6// "CMD_SERVO"           //SERVO control command
#define CMD_CAMERA         7// "CMD_CAMERA"          //SERVO control command

#define CMD_LED_MOD        0// "CMD_LED_MOD"         //WS2812 control command
#define CMD_LED            1// "CMD_LED"             //WS2812 color command
#define CMD_MATRIX_MOD     2// "CMD_MATRIX_MOD"      //LED MATRIX control command
#define CMD_VIDEO          3// "CMD_VIDEO"           //VIDEO control command
#define CMD_LIGHT          8// "CMD_LIGHT"           //LIGHT Car control command
#define CMD_TRACK          9// "CMD_TRACK"           //TRACK Car control command
#define CMD_CAR_MODE       10//"CMD_CAR_MODE"        //Car control command
